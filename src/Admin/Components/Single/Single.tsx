...
// const Single: React.FC<Props> = ({ id, img, title, info, chart, activities }) => {
//   return (
      ...
      <Card>
        ...
        <CardContent>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <Typography variant="body2" color="textSecondary">Profile Created At:</Typography>
              <Typography variant="body1">{new Date(person.createdAt).toLocaleDateString()}</Typography>
            </Grid>
          </Grid>
        </CardContent>
      </Card>
